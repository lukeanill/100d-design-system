...
} from '@workspace/ui/components/animate-ui/primitives/base/accordion';
  ...
  return (
    <AccordionHeaderPrimitive className="flex">
      ...
      >
        {children}
        {showArrow && (
          <ChevronDownIcon className="text-foreground/75 pointer-events-none size-4 shrink-0 translate-y-0.5 transition-transform duration-200" />
        )}
      </AccordionTriggerPrimitive>
