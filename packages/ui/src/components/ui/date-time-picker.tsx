      ...
      <div className="flex justify-center">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            >
              <ChevronLeft className="size-5 text-foreground/75" />
            </button>
            ...
            <button
              ...
              className="p-1 hover:bg-muted rounded transition-colors"
            >
              <ChevronRight className="size-5 text-foreground/75" />
            </button>
          </div>
          ...
          <div className="grid grid-cols-7 mb-2">
            {orderedDays.map((day) => (
              <div
                key={day}
                className="text-center text-xs font-medium text-foreground/75 py-2"
              >
                {day}
              </div>
            ))}
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    !item.isCurrentMonth && "text-foreground/30",
                    item.isCurrentMonth &&
                      !isAvailable &&
                      "text-foreground/75 cursor-default",
                    item.isCurrentMonth &&
                      isAvailable &&
                      !isSelected &&
                ...
                <PopoverPanel className="w-[320px] p-0" align="start">
                  <div className="p-2 border-b">
                    <div className="relative">
                      <Search className="absolute left-2.5 top-1/2 -translate-y-1/2 size-4 text-foreground/75" />
                      <input
        ...
        >
          <div className="w-full md:w-[200px]">
            ...
            <button
              ...
              className="flex items-center gap-2 text-sm text-foreground/75 hover:text-foreground mb-4 md:hidden"
            >
