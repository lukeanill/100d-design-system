  ...
  return (
    ...
    >
      <CheckboxPrimitive.Indicator
        ...
        keepMounted
        className="grid scale-50 place-content-center text-current opacity-0 transition-[opacity,transform] duration-150 ease-out data-checked:scale-100 data-checked:opacity-100 [&>svg]:size-3.5"
      >
        <CheckIcon
        />
      </CheckboxPrimitive.Indicator>
