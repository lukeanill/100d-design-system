...
function IconWrapper<T extends string>({
  ...
  if (
    ...
    return (
      <AnimateIcon asChild animate={animate} animateOnHover={animateOnHover} animateOnTap={animateOnTap} animateOnView={animateOnView} animateOnViewMargin={animateOnViewMargin} animateOnViewOnce={animateOnViewOnce} animation={animationProp} loop={loop} loopDelay={loopDelay} delay={delay} completeOnStop={completeOnStop}><IconComponent size={size} className={cn(
                    className,
